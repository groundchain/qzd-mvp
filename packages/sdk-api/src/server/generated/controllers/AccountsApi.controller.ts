...
import type { Account, Balance, CreateAccountRequest, ListAccountTransactions200Response, UploadAccountKycRequest,  } from '../models/index.js';
...
export class AccountsApiController {
  ...
  @Post('/accounts/kyc')
  uploadAccountKyc(@Body() uploadAccountKycRequest: UploadAccountKycRequest, @Req() request: Request): Account | Promise<Account> | Observable<Account> {
    return this.accountsApi.uploadAccountKyc(uploadAccountKycRequest, request);
  }
