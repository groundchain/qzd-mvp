...
export const RemittancesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        simulateQuote: async (usdAmount: string, scenario?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'usdAmount' is not null or undefined
            assertParamExists('simulateQuote', 'usdAmount', usdAmount)
            ...
            if (usdAmount !== undefined) {
                localVarQueryParameter['usdAmount'] = usdAmount;
            }
...
export const RemittancesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async acquireQZDForUSRemittance(uSRemitAcquireQZDRequest: USRemitAcquireQZDRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Transaction>> {
         ...
         * @throws {RequiredError}
         */
        async simulateQuote(usdAmount: string, scenario?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuoteResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.simulateQuote(usdAmount, scenario, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const RemittancesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        acquireQZDForUSRemittance(requestParameters: RemittancesApiAcquireQZDForUSRemittanceRequest, options?: RawAxiosRequestConfig): AxiosPromise<Transaction> {
        ...
        simulateQuote(requestParameters: RemittancesApiSimulateQuoteRequest, options?: RawAxiosRequestConfig): AxiosPromise<QuoteResponse> {
            return localVarFp.simulateQuote(requestParameters.usdAmount, requestParameters.scenario, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface RemittancesApiSimulateQuoteRequest {
    ...
    /**
     * Pricing program to apply to the remittance quote. Allowed values: DEFAULT, TARIFFED, SUBSIDIZED. 
     */
...
export class RemittancesApi extends BaseAPI {
    ...
    public simulateQuote(requestParameters: RemittancesApiSimulateQuoteRequest, options?: RawAxiosRequestConfig) {
        return RemittancesApiFp(this.configuration).simulateQuote(requestParameters.usdAmount, requestParameters.scenario, options).then((request) => request(this.axios, this.basePath));
    }
}
